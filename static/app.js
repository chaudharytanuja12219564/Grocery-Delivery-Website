...
function displayItems(){
    ...
    var southIndian=  document.getElementById('toiletries');

    

    const fruitsData= foodItem.filter((item)=>item.category=='fruits');
    const veggiesData= foodItem.filter((item)=>item.category=='veggies');
    const snacksData= foodItem.filter((item)=>item.category=='snacks');
    const groceriesData= foodItem.filter((item)=>item.category=='groceries');
    const IcecreamData= foodItem.filter((item)=>item.category=='Icecream');
    const southData= foodItem.filter((item)=>item.category=='toiletries');
    fruitsData.map(item=>{
...
//         var listName = document.createElement('a');
//         listName.setAttribute('class', 'list-name');
//         listName.innerText = getCategoryName(item.category); // Function to get appropriate category name
//         listName.setAttribute('href', '#' + item.category);
...
// // Function to get appropriate category name
